...
public final class CameraManager {
	...
	int offset = StrUtil.dip2px(null, 15);

	public void setFramingRectInPreview(int width, int height) {
	...
	public Rect getFramingRectInPreview0() {
