...
public class SecondScrollHPageView extends RelativeLayout {
	...
	public SecondScrollHPageView(Context context) {
		super(context);
		oncreate(context);
	}

	public SecondScrollHPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		oncreate(context);
	}

	public SecondScrollHPageView(Context context, AttributeSet attrs, int defStyle) {
	...
	void oncreate(Context context) {
		...
		SecondScrollHPageView.this.addView(mViewPager, paramViewPage);
