...
public class UpdateWeixinActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomDialog.createConfirmDialog(mActivity, "请输入新微信号码",true,
					...
					public void onConfirm(String phone) {
						if (phone != null) {
							Pdtask task = new Pdtask(mActivity, mActivity,
									...
									true);
							task.addParam("method", "setUserWeixin");// 页码
							...
							task.addParam("weixin", phone);// 页码
							//task.addParam("wx_code", phone);// 页码
