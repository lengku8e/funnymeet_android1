...
public class HDBrandListActivity extends Activity implements DownBack {
	...
	void init() {
		...
		mListView.setAdapter(new BaseAdapter() {
			String[] person = new String[] { "Dior", "intel", "Baidu",
					"Alipay", "Tencent", "Microsoft" };
		...
		if (typeView == null) {
			typeView = new TypeSelectView(mActivity, typeList) {
				...
				public void onSelectType1(JSONObject sJson) {
					...
					HDBrandListActivity.this.requestData(1);
				}
