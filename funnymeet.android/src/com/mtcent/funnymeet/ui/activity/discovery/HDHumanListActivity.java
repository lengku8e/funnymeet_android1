...
public class HDHumanListActivity extends Activity implements DownBack {
	...
	void init() {
		...
		mListView.setOnItemClickListener(new ListView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				mBundle.putString("title",
						(String) mListView.getItemAtPosition(arg2));
		...
		mListView.setAdapter(new BaseAdapter() {
			String[] person = new String[] { "李彦宏", "马化腾", "马云", "雷军", "柳传志" };
		...
		TextView vv = (TextView) findViewById(R.id.type2);
		vv.setText("评级");
		...
		priceSelect.setVisibility(View.INVISIBLE);
		...
		disSelect.setVisibility(View.INVISIBLE);
		...
		if (typeView == null) {
			typeView = new TypeSelectView(mActivity, typeList) {
				...
				public void onSelectType1(JSONObject sJson) {
					...
					HDHumanListActivity.this.requestData(1);
				}
