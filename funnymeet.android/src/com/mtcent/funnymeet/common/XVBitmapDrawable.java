...
package com.mtcent.funnymeet.common;
...
public class XVBitmapDrawable extends Drawable {
     ...
     */
//    @Deprecated
//    public XVBitmapDrawable() {
//        mBitmapState = new BitmapState((Bitmap) null);
//    }

    public  CGETBITMAP bitmapGetter = null;
    
    /**
     * Create an empty drawable, setting initial target density based on
     * the display metrics of the resources.
     */
//    public XVBitmapDrawable(Resources res) {
//        mBitmapState = new BitmapState((Bitmap) null);
...
//    }
     ...
     */
//    @Deprecated
//    public XVBitmapDrawable(Bitmap bitmap) {
...
//    }
     ...
     * the display metrics of the resources.
     */
    public XVBitmapDrawable(Resources res, CGETBITMAP cgetbitmap) {
        this(new BitmapState(cgetbitmap), res);
        mBitmapState.mTargetDensity = mTargetDensity;
    }
     ...
     */
//    @Deprecated
//    public XVBitmapDrawable(String filepath) {
...
//    }
     ...
     * Create a drawable by opening a given file path and decoding the bitmap.
     */
//    public XVBitmapDrawable(Resources res, String filepath) {
//        this(new BitmapState(BitmapFactory.decodeFile(filepath)), null);
//        mBitmapState.mTargetDensity = mTargetDensity;
//        if (mBitmap == null) {
//            android.util.Log.w("BitmapDrawable", "BitmapDrawable cannot decode " + filepath);
...
//    }
     ...
     */
//    @Deprecated
//    public XVBitmapDrawable(java.io.InputStream is) {
...
//    }
     ...
     * Create a drawable by decoding a bitmap from the given input stream.
     */
//    public XVBitmapDrawable(Resources res, java.io.InputStream is) {
//        this(new BitmapState(BitmapFactory.decodeStream(is)), null);
//        mBitmapState.mTargetDensity = mTargetDensity;
//        if (mBitmap == null) {
//            android.util.Log.w("BitmapDrawable", "BitmapDrawable cannot decode " + is);
...
//    }
    ...
    public final Bitmap getBitmap() {
        return bitmapGetter.getBitmap();
    }

    private void computeBitmapSize() {
    	Bitmap mBitmap = bitmapGetter.getBitmap();
    	if(mBitmap!=null){
    ...
    private void setBitmap(CGETBITMAP bitmap) {
    	bitmapGetter = bitmap;
        if (bitmap != null) {
            computeBitmapSize();
        } else {
    ...
    public void setTargetDensity(DisplayMetrics metrics) {
        ...
        if (bitmapGetter.getBitmap() != null) {
            computeBitmapSize();
        }
    }
...
//        a.recycle();
    ...
    public int getOpacity() {
        ...
        Bitmap bm = bitmapGetter.getBitmap();
    ...
    final static class BitmapState extends ConstantState {
        ...
        public Drawable newDrawable(Resources res) {
            return new XVBitmapDrawable(this, res);
        }
    ...
    private XVBitmapDrawable(BitmapState state, Resources res) {
        mBitmapState = state;
        if (res != null) {
